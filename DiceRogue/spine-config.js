...
window.SPINE_CONFIG = {
    ...
    enemies: {
        'Giant Rat': { folder: 'Monster_Lv1', json: 'Monster_Lv1.json', atlas: 'Monster_Lv1.atlas.txt', scale: 0.015, defaultAnimation: 'Monster1_Fly_01' },
        'Goblin':     { folder: 'Monster_Lv2', json: 'Monster_Lv2.json', atlas: 'Monster_Lv2.atlas.txt', scale: 0.015, defaultAnimation: 'Monster2_Fly_01' },
        'Orc':        { folder: 'Monster_Lv3', json: 'Monster_Lv3.json', atlas: 'Monster_Lv3.atlas.txt', scale: 0.015, defaultAnimation: 'Monster3_Down_01' },
        'Troll':      { folder: 'Monster_Lv4', json: 'Monster_Lv4.json', atlas: 'Monster_Lv4.atlas.txt', scale: 0.015, defaultAnimation: 'Monster4_Down_01' },
        'Dragon':     { folder: 'Monster_Lv5', json: 'Monster_Lv5.json', atlas: 'Monster_Lv5.atlas.txt', scale: 0.015, defaultAnimation: 'Monster5_Fly_01' }
    }
};
